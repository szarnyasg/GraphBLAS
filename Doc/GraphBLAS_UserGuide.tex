...
\verb'double _Complex' type, the following can be used.  A complete example can
...
\verb'Demo' folder.
    ...
    #include <complex.h>
    GrB_Type Complex ;
    GrB_Type_new (&Complex, sizeof (double _Complex)) ;    \end{verbatim} }
...
\newpage
%-------------------------------------------------------------------------------
\subsection{User-defined types and operators: double _Complex and struct-based}
%-------------------------------------------------------------------------------
\label{user}

The \verb'Demo' folder contains two working examples of user-defined types,
first discussed in Section~\ref{type_new}: \verb'double _Complex', and a
...
type based on the ANSI C11 \verb'double _Complex' type.
